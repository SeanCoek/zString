...
\author{Xilong~Zhuo,
        Chenyi~Zhang
        \IEEEcompsocitemizethanks{\IEEEcompsocthanksitem Corresponding email: chenyi\_zhang@jnu.edu.cn}
        % <-this % stops a space
...
\begin{IEEEkeywords}
Type Analysis, Static Analysis, Method Resolving.
\end{IEEEkeywords}}
...
\IEEEPARstart{F}{or} object-oriented programming languages, virtual methods (or functions) are those declared in a base class but are meant to be overridden in different child classes. Statically determine a set of methods that may be invoked at a call site is important to program optimization...
...
\subsubsection{Instrumentation}\label{subsubsec:instrument}
...
We thank Bernhard Scholz for his guidance in our experiment regarding JVM configurations. We also thank anonymous reviewers
...
\begin{IEEEbiography}{Xilong Zhuo}
Biography text here.
\end{IEEEbiography}

% if you will not have a photo at all:
\begin{IEEEbiographynophoto}{Chenyi Zhang}
Biography text here.
