...
public class PointsTo {
    ...
    public static void main(String[] args) {
        Scene.v().setSootClassPath(".:/home/sean/bench_compile/:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:" +
...
//        SootClass c = loadClass(args[1],true);
        SootClass c = loadClass(args[1], false);
...
//        SootField f = getField("Container","item");
        Map/*<Local>*/ ls = getLocals(c,args[2],"basic.ObjectA");
